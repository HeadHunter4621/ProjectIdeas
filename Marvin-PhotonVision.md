...
## Parts Required: 
- Marvin (free?)
  - Needs repairs at the moment (replace PoE)
- ArduCams (we have them already, not sure if we have enough though)
  - Mounts already exist and are mounted on Marvin
- BeeLink and power adapter (we have BeeLinks but I'm unsure about how it's powered, also need to figure out radio wiring)
